...
class Mailer{
    ...
    public function __construct($toAddress, $toName, $subject, $tplName, $data = array()){ 
        ...
        $html = $tpl->draw($tplName, true); //true pra jogar na variável e não jogar na tela
        ...
        $this->mail = new \PHPMailer; //PHPMailer está no escopo principal e tem que colocar \
        ...
        $this->mail->SMTPDebug = 0; //0 não dá as mensagem de log do envio do email, pra aparecer todas as mensagem coloque 2
        ...
        $this->mail->Username = Mailer::USERNAME; //NESTE PROJETO USAR UMA CONSTANTE pra se precisar mudar o email que é utilizado pra enviar pelo sistema
